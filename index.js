...
function addFlavor(array, newflavorstring){
    array.unshift(newflavorstring)
    return array

};

console.log('task 3', addFlavor(originalFlavors, 'Birthday Cake'));
...
console.log('task 5', getFlavorByIndex(originalFlavors,6));
...
function removeFlavorByName(array, flavorString){ 
    array.splice(array.indexOf(flavorString), 1)
    return array
}

console.log('task 6', removeFlavorByName(originalFlavors, 'Cofee'));
